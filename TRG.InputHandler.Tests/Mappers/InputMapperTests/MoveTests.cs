...
namespace TRG.InputHandler.Tests.Mappers.InputMapperTests
{
    public class MoveTests
    {
        ...
        public void Map_When_Move_Command_Is_Correct_Returns_MovementCommandType()
        {
            ...
            commandMapper.Map(Arg.Is<string>(x => x == "MOVE"), Arg.Is<List<string>>(x => x == null), Arg.Any<Grid>()).Returns(new Movement(MovementCommand.Forward));
        ...
        public void Map_When_Move_Command_Has_Parameters_Returns_Null()
        {
            ...
            commandMapper.Map(Arg.Is<string>(x => x == "MOVE"), Arg.Is<List<string>>(x => x.Count > 0), Arg.Any<Grid>()).Returns((Movement)null);
