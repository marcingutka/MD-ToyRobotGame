...
namespace TRG.InputHandler.Tests.Mappers.InputMapperTests
{
    public class PlaceWallTests
    {
        ...
        [Test]
        public void Map_For_One_Command_When_PlaceWall_Command_Is_Correct_Returns_CorrectPlaceWallCommandType()
        {
            //Arrange
            var grid = new Grid(5, 5);
            var command = "PLACE_WALL 2,3";
        ...
        [Test]
        public void Map_For_One_Command_When_PlaceWall_Command_Is_Correct_Returns_CorrectPlaceWallObject()
        {
            //Arrange
            var grid = new Grid(5, 5);
            var command = "PLACE_WALL 2,3";
        ...
        [Test]
        public void Map_For_One_Command_When_PlaceWall_Command_Is_Correct_Returns_CorrectPlacementRow()
        {
            //Arrange
            var grid = new Grid(5, 5);
            var command = "PLACE_WALL 2,3";
            ...
            //Act
            var mappedCommand = mapper.Map(command, grid) as PlaceWall;
        ...
        [Test]
        public void Map_For_One_Command_When_PlaceWall_Command_Is_Correct_Returns_CorrectPlacementColumn()
        {
            //Arrange
            var grid = new Grid(5, 5);
            var command = "PLACE_WALL 2,3";
        ...
        [Test]
        public void Map_For_One_Command_When_PlaceWall_Command_Has_Invalid_Row_Returns_Null()
        {
            //Arrange
            var grid = new Grid(5, 5);
            var command = "PLACE_WALL 6,3";
        ...
        [Test]
        public void Map_For_One_Command_When_PlaceWall_Command_Has_Invalid_Column_Returns_Null()
        {
            //Arrange
            var grid = new Grid(5, 5);
            var command = "PLACE_WALL 2,6";
