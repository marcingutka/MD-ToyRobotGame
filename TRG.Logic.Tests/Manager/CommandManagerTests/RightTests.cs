...
namespace TRG.Logic.Tests.Manager.CommandManagerTests
{
    public class RightTests
    {
        ...
        [Test]
        public void Execute_WHEN_Right_Command_AND_There_Is_No_Robot_DO_NOT_Change_Orientation()
        {
            //Arrange
            var grid = new Grid(5, 5);
            List<GridPoint> gridPoints = new();
            Robot robot = null;
            var command = new Movement(MovementCommand.Right);
        ...
        [Test]
        public void Execute_WHEN_Right_Command_AND_There_Is_Robot_With_Orientation_North_SET_Robot_Orientation_To_East()
        {
            //Arrange
            var grid = new Grid(5, 5);
            List<GridPoint> gridPoints = new();
        ...
        [Test]
        public void Execute_WHEN_Right_Command_AND_There_Is_Robot_With_Orientation_East_SET_Robot_Orientation_To_South()
        {
            //Arrange
            var grid = new Grid(5, 5);
            List<GridPoint> gridPoints = new();
        ...
        [Test]
        public void Execute_WHEN_Left_Command_AND_There_Is_Robot_With_Orientation_South_SET_Robot_Orientation_To_West()
        {
            //Arrange
            var grid = new Grid(5, 5);
            List<GridPoint> gridPoints = new();
        ...
        [Test]
        public void Execute_WHEN_Left_Command_AND_There_Is_Robot_With_Orientation_West_SET_Robot_Orientation_To_North()
        {
            //Arrange
            var grid = new Grid(5, 5);
            List<GridPoint> gridPoints = new();
